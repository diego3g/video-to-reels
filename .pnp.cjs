...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      ...
      {\
        "name": "video-to-reels-server",\
        "reference": "workspace:packages/server"\
      },\
      {\
        "name": "video-to-reels-ui",\
    ...
    "fallbackExclusionList": [\
      ["video-to-reels", ["workspace:."]],\
      ["video-to-reels-server", ["workspace:packages/server"]],\
      ["video-to-reels-ui", ["workspace:packages/ui"]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
